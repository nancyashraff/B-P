...
const seedProducts = async (req, res) => {
  try {
    ...
    const products = [
      // ── PERFUMES - MEN 60ml ──
      { name: '60ml perfume', price: 300, category: 'perfumes', size: '60ml', gender: 'men', image: 'perfumeBoy.jpeg',
        scents: ['Black Phantom','Creed Silver','3G','Y Saint Laurent','Legend Blue MONTBLANC'] },

      { name: '60ml perfume', price: 350, category: 'perfumes', size: '60ml', gender: 'men', image: 'perfumeBoy.jpeg',
      ...
      { name: '60ml perfume', price: 370, category: 'perfumes', size: '60ml', gender: 'men', image: 'perfumeBoy.jpeg',
        scents: ['Khamra','Jimmy Choo','Tom Ford Tobacco Vanille','Asad','Blonde Amber','Zara Gold','Midnight Blue','BMW']},

      { name: '60ml perfume', price: 420, category: 'perfumes', size: '60ml', gender: 'men', image: 'perfumeBoy.jpeg',
        scents: ['HUGO','Baccarat Rouge','Azzaro Wanted','Bianco Latte',"Angel's Share",'Enigma','ZARA For Him','Romance','Shaghaf']},

      { name: '60ml perfume', price: 470, category: 'perfumes', size: '60ml', gender: 'men', image: 'perfumeBoy.jpeg',
        ...
        { name: '60ml perfume', price: 530, category: 'perfumes', size: '60ml', gender: 'men', image: 'perfumeBoy.jpeg',
        scents: ['Black Afgano','Pacific Chill','TOM FORD Oud Wood'] },

        { name: '60ml perfume', price: 650, category: 'perfumes', size: '60ml', gender: 'men', image: 'perfumeBoy.jpeg',
        scents: ['1001 Nights'] },

      // ── PERFUMES - MEN 100ml ──
      { name: '100ml perfume', price: 470, category: 'perfumes', size: '100ml', gender: 'men', image: 'perfumeBoyLarge.jpeg',
        scents: ['Black Phantom','Creed Silver','3G','Y Saint Laurent','Legend Blue MONTBLANC'] },

     { name: '100ml perfume', price: 520, category: 'perfumes', size: '100ml', gender: 'men', image: 'perfumeBoyLarge.jpeg',
        scents: ['Sauvage','Stronger With You','Dunhill Desire','Sculpture','212 VIP','Blue de Chanel','Ultra Male','Strong Me','Karizma','Lacoste White','Issey Miyake','Voyage','1Million Lucky','Invictus','Black Phantom','Black Phantom','Versace eros',"Black L'EXCES"] },

      { name: '100ml perfume', price: 580, category: 'perfumes', size: '100ml', gender: 'men', image: 'perfumeBoyLarge.jpeg',
        scents: ['Khamra','Jimmy Choo','Tom Ford Tobacco Vanille','Asad','Blonde Amber','Zara Gold','Midnight Blue','BMW']},

      { name: '100ml perfume', price: 680, category: 'perfumes', size: '100ml', gender: 'men', image: 'perfumeBoyLarge.jpeg',
        scents: ['HUGO','Baccarat Rouge','Azzaro Wanted','Bianco Latte',"Angel's Share",'Enigma','ZARA For Him','Romance','Shaghaf']},

      { name: '100ml perfume', price: 780, category: 'perfumes', size: '100ml', gender: 'men', image: 'perfumeBoyLarge.jpeg',
        scents: ['Imagination','Erba Pura','Oud Madawy','Layton De Marly','Le Male Elixir','Valentino Born In Rome','Nishane Hacivat','Ana Abiyedh'] },

        { name: '100ml perfume', price: 890, category: 'perfumes', size: '100ml', gender: 'men', image: 'perfumeBoyLarge.jpeg',
        scents: ['Black Afgano','Pacific Chill','TOM FORD Oud Wood'] },

        { name: '100ml perfume', price: 1150, category: 'perfumes', size: '100ml', gender: 'men', image: 'perfumeBoyLarge.jpeg',
        scents: ['1001 Nights'] },

      // ── PERFUMES - WOMEN 60ml ──
      { name: '60ml perfume', price: 300, category: 'perfumes', size: '60ml', gender: 'women', image: 'perfumeGirl.jpeg',
        scents: ['Good Girl','Versace Crystal Noir','Si Passione','Pink Sugar','Coco Chanel'] },

      { name: '60ml perfume', price: 350, category: 'perfumes', size: '60ml', gender: 'women', image: 'perfumeGirl.jpeg',
      ...
      { name: '60ml perfume', price: 370, category: 'perfumes', size: '60ml', gender: 'women', image: 'perfumeGirl.jpeg',
        scents: ['Khamra','Pomegranate Musk','Oud Bouquet','Oud Jassim','Delina de Marly'] },

      // ── PERFUMES - WOMEN 100ml ──
      { name: '100ml perfume', price: 470, category: 'perfumes', size: '100ml', gender: 'women', image: 'PerfumeGirlLarge.jpeg',
        scents: ['Good Girl','Versace Crystal Noir','Si Passione','Pink Sugar','Coco Chanel'] },

      { name: '100ml perfume', price: 520, category: 'perfumes', size: '100ml', gender: 'women', image: 'PerfumeGirlLarge.jpeg',
        scents: ['Love is Healthy','Burberry Her','Victoria Secret Bombshell','Black Opium','Olympea','Libre','Mancera Roses Vanille','Scandal','Yara Pink','Kenzo Flower','Into the Night','In the Stars','Dark Kiss','Mancera Coco Vanille']},

      { name: '100ml perfume', price: 580, category: 'perfumes', size: '100ml', gender: 'women', image: 'PerfumeGirlLarge.jpeg',
        scents: ['Khamra','Pomegranate Musk','Oud Bouquet','Oud Jassim','Delina de Marly'] },
